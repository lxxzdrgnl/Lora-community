...
INSERT INTO lora_models (user_id, title, description, character_name, style, training_images_count, epochs, learning_rate, lora_rank, s3_key, file_size, base_model, is_public, status, view_count, like_count, created_at, updated_at) VALUES
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            (0, 'Mouri Kogorou', '명탐정 코난 모리 코고로', 'Mouri Kogoro', 'anime', 20, 30, 0.00008, 32, '2/Mouri_Kogorou.safetensors', 104857600, 'stablediffusionapi/anything-v5', TRUE, 'COMPLETED', 580, 92, DATEADD('DAY', -8, CURRENT_TIMESTAMP()), CURRENT_TIMESTAMP()),
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            (0, 'Kamado Tanjiro', '귀멸의 칼날 탄지로', 'Kamado', 'manga', 120, 25, 0.00015, 16, '4/Tanjiro.safetensors', 52428800, 'stablediffusionapi/anything-v5', TRUE, 'COMPLETED', 155, 29, DATEADD('DAY', -5, CURRENT_TIMESTAMP()), CURRENT_TIMESTAMP()),
...
INSERT INTO model_samples (model_id, image_url, prompt, negative_prompt, steps, guidance_scale, seed, display_order, is_primary, created_at, updated_at) VALUES
                                                                                                                                                             ...
                                                                                                                                                             (5, 'https://lora-generated-image-bucket.s3.ap-northeast-2.amazonaws.com/0/tanji_2.png', 'cyberpunk mecha...', 'cute...', 32, 8.2, 141414, 2, FALSE, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
                                                                                                                                                             ...
                                                                                                                                                             (6, 'https://picsum.photos/512/512?random=701', 'cute rabbit...', 'realistic...', 20, 7.0, 161616, 1, TRUE, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
